  ...
  return (
    <div class="bg-gradient-to-br from-purple-950 via-violet-500 to-cyan-500   bg-dvh h-full">
      ...
      <div className='text-white text-4xl font-stalinist mx-4 pt-2'>ContactUs</div>
        ...
        <div>
          <div className=" my-[15px] w-[70rem] mx-auto rounded-[8px] flex shadow-2xl shadow-white hover:shadow-purple-400 backdrop-grayscale backdrop-opacity-40">
          
          <form onSubmit={handleSubmit} className=" mt-5 ml-[20px] mx-[10rem]  w-[32.8rem] h-[40rem] rounded-lg ">
          ...
          <div className="w-[70rem] mt-5 mr-5 mb-10 rounded-[5px] relative" style={{ marginLeft: '-140px' }}>
