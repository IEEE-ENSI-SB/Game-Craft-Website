...
function ContactUs() {
  ...
  return (
    ...
    <div class="bg-gradient-to-br from-purple-950 via-violet-500 to-cyan-500 border-[1px] border-white ls:mt-[14rem] ss:mt-[0rem] sm:mt[-1rem]  ">
    
      <div className='text-white text-4xl font-stalinist mx-4 pt-2'>ContactUs</div>

      <div className='pb-4'>
        <div className=" mt-6 mb-12   mx-auto rounded-[8px] shadow-2xl shadow-white hover:shadow-purple-400 backdrop-grayscale backdrop-opacity-40   mb-10 bg-no-repeat ls:ml-2 ls:mr-2 ss:mx-auto ss:max-w-[90%]   sm:flex sm:border-black sm:w-[90%] md:flex lg:max-w-[72rem] ">
          
          <div className="  overflow-hidden w-full  rounded-[5px] relative sm:border ls:h-[13rem] ss:h-[13rem] sm:h-[40rem] sm:mt-5 sm:mx-auto sm:w-[48%] ">
          ...
          <form onSubmit={handleSubmit} className=" grid mt-5  mx-auto mb-[10px] h-[40rem] rounded-lg sm:w-[48%] ">
